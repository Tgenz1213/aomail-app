"""
Django Rest Framework (DRF) URL Configuration for RESTful API.
"""
...
urlpatterns = [
    ...
    path('api/check_sender', views.check_sender_for_user, name='check_sender_for_user'),
    ...
    path('user/update-rule/', views.update_user_rule, name='update_user_rule'),
    #----------------------- API -----------------------#
