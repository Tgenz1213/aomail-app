...
class EmailReplyConversation:
    ...
    def improve_email_response(self, user_input: str) -> str:
        ...
        Returns:
            str: The improved email response in HTML format.
        """
...
class GenerateEmailConversation:
    ...
    def improve_draft(self, user_input: str, language: str) -> tuple[str, str]:
        """
        ...
        Returns:
            tuple[str, str]: The improved subject and body of the email in HTML format.
        """
