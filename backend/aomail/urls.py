...
urlpatterns = [
    ...
    path('search_emails_ai/', ai.search_emails_ai , name='search_emails_ai'), # ok
    path('search_tree_knowledge/', ai.search_tree_knowledge, name='search_tree_knowledge'), # ok
    path('find_user_ai/', ai.find_user_view_ai, name='find_user_view_ai'), # ok
    path('new_email_ai/', ai.new_email_ai, name='new_email_ai'), # ok
    path('correct_email_language/', ai.correct_email_language, name='correct_email_language'), # ok
    path('check_email_copywriting/', ai.check_email_copywriting, name='check_email_copywriting'), # ok
    path('generate_email_response_keywords/', ai.generate_email_response_keywords, name='generate_email_response_keywords'), # ok
    path('generate_email_answer/', ai.generate_email_answer, name='generate_email_answer'), # ok
    path('get_new_email_response/', ai.get_new_email_response, name='get_new_email_response'), # ok
    path('improve_draft/', ai.improve_draft, name='improve_draft'), # ok
