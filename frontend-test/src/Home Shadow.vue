<template>
    ...
    <main class="py-7 lg:pl-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="col-span-4 pb-5">
                    <div>
                        ...
                        <div class="hidden sm:block">
                            <nav class="isolate flex divide-x divide-gray-200 rounded-lg" aria-label="Tabs">
                                <!-- Current: "text-gray-900", Default: "text-gray-500 hover:text-gray-700" -->
                                <a href="#" class="text-700 text-white dark:text-indigo-400 rounded-l-lg group relative min-w-0 flex-1 overflow-hidden bg-indigo-500 dark:bg-gray-800 py-4 px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10" aria-current="page">
                                    <span>ESAIP</span>
                                </a>
                                ...
                                <a href="#" class="text-gray-500 dark:text-white hover:text-gray-700 rounded-r-lg group relative min-w-0 flex-1 overflow-hidden bg-white dark:bg-gray-800 py-4 px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                                    <span>Nouveau</span>
                                </a>
                            </nav>
                        </div>
            ...
            <div class="inline-block min-h-[81vh] w-full px-8 pb-8 rounded-lg bg-white dark:bg-gray-800 ring-1 ring-indigo-600/20 dark:border-indigo-500 dark:border-2 shadow">
                <!-- Content goes here -->
                <ul role="list" class="">
                    <li class="py-10">
                        <!-- Your content -->
