<template>
    ...
    <main class="py-7 lg:pl-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-4 pt-8">
                    <div class="grid grid-cols-4 gap-0 flex flex-col justify-center h-full">
                        <div class="flex flex-col justify-center items-center h-full bg-white rounded-t-lg border-l-2 border-l-indigo-600/20 border-r-2 border-r-indigo-600/20 border-t-2 border-t-indigo-600/20 z-10 pt-2">
            ...
            <div class="inline-block min-h-[81vh] w-full px-8 pb-8 rounded-lg bg-white ring-1 ring-indigo-600/20">
                <!-- Content goes here -->
                <ul role="list" class="divide-y divide-gray-200">
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-red-50 bg-opacity-70 shadow" @click="toggleHiddenParagraph(0)">
                                    <ul role="list" class="divide-y divide-gray-200">
                                        <li class="px-6 py-4 hover:bg-red-50 ">
                                            <p class="text-red-500">
                                                <a href="#" class="underline font-semibold text-red-600 hover:text-red-700">Cristophe Rouvrais</a> qui parle de l'aventure entrepreneuriale de Malcom Morel.
                                            </p>
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-blue-50 bg-opacity-70 shadow">
                                    <ul role="list" class="divide-y divide-gray-200">
                                        <li class="px-6 py-4 hover:bg-blue-50" @click="toggleHiddenParagraph(1)">
                                            <p class="text-blue-500">
                                                <a href="#" class="underline font-semibold text-blue-600 hover:text-blue-700">Fabien Huet</a> qui parle de ses vacances et son projet d'enteprise.
                                            </p>
                                        ...
                                        <li class="px-6 py-4 hover:bg-blue-50" @click="toggleHiddenParagraph(2)">
                                            <p class="text-blue-500">
                                                <a href="#" class="underline font-semibold text-blue-600 hover:text-blue-700">Hannah Williams</a> qui vous donne des conseils pour votre rapport d'étonnement.
                                            </p>
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gray-100 bg-opacity-70 shadow" @click="toggleHiddenParagraph(3)">
                                    <ul role="list" class="divide-y divide-gray-200">
                                        <li class="px-6 py-4 hover:bg-gray-100">
                                            <p class="text-gray-500">
                                                Vous avez reçu <span class="underline font-semibold text-gray-600 hover:text-gray-700">4</span> mails inutiles
                                            </p>
