<template>
    ...
    <main class="py-7 lg:pl-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <div class="hidden sm:block">
                            <nav class="isolate flex divide-x divide-gray-200 rounded-t-lg" aria-label="Tabs">
                                ...
                                <a href="#" class="text-gray-900 rounded-tl-lg group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10" aria-current="page">
                                    <span>ESAIP</span>
                                    <span aria-hidden="true" class="bg-indigo-500 absolute inset-x-0 bottom-0 h-0.5 z-20"></span>
                                </a>
                                ...
                                <a href="#" class="text-gray-500 hover:text-gray-700 rounded-tr-lg group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10">
                                    <span>Nouveau</span>
                                    <span aria-hidden="true" class="bg-indigo-600/20 absolute inset-x-0 bottom-0 h-[1px]"></span>
                                </a>
                            </nav>
            ...
            <div class="inline-block min-h-[81vh] w-full px-8 pb-8 rounded-lg rounded-tr-none bg-white ring-1 ring-indigo-600/20">
                <!-- Content goes here -->
