                ...
                <ul role="list" class="divide-y divide-gray-200">
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-red-50 shadow" @click="toggleHiddenParagraph(0)">
                                    <ul role="list" class="divide-y divide-gray-200">
                                        <li class="px-6 py-4 bg-red-50 hover:bg-opacity-70 ">
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gray-100 shadow" @click="toggleHiddenParagraph(3)">
                                    <ul role="list" class="divide-y divide-gray-200">
