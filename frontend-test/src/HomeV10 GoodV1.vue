<template>
    ...
    <div class="h-screen flex flex-col pr-4 pl-60 py-4">
                ...
                <div class="col-span-7 h-full flex items-center pb-5">
                    <div class="w-full flex items-center justify-center pt-5">
                        ...
                        <div class="hidden sm:block w-full">
                            ...
                            <a href="#" class=" text-gray-600 hover:bg-white hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Ecole ESAIP</a>
                            <a href="#" class=" text-gray-600 hover:bg-white hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Entrepreneuriat</a>
                            <a href="#" class=" text-gray-600 hover:bg-white hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Administratifs</a>
                            <a href="#" class=" bg-white text-gray-800 rounded-md px-16 py-2 text-sm font-medium" aria-current="page">Autres</a>
                            </nav>
                        </div>
                    </div>
                </div>
    ...
    <div class="flex-1 flex justify-center rounded-xl lg:mt-4 bg-white ring-1 shadow-sm ring-black ring-opacity-5">
                <!-- Content goes here -->
                <ul role="list" class="">
                    <li class="pt-10">
                        <!-- Your content -->
