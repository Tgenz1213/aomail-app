                ...
                <div class="flex flex-col h-[750px] w-[1125px] 2xl:h-[850px] 2xl:w-[1424px]">
                                ...
                                <div class="col-span-7 h-full flex items-center pb-5">
                                    <div class="w-full flex items-center justify-center pt-5">
                                        ...
                                        <div class="hidden sm:block w-full">
                                            ...
                                            <a href="#" class=" text-gray-600 hover:bg-gray-500 hover:bg-opacity-10 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Ecole ESAIP</a>
                                            <a href="#" class=" text-gray-600 hover:bg-gray-500 hover:bg-opacity-10 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Entrepreneuriat</a>
                                            <a href="#" class=" text-gray-600 hover:bg-gray-500 hover:bg-opacity-10 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Administratifs</a>
                                            <a href="#" class=" bg-gray-500 bg-opacity-10 text-gray-800 rounded-md px-16 py-2 text-sm font-medium" aria-current="page">Autres</a>
                                            </nav>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="flex-1 rounded-xl bg-white lg:mt-4 ring-1 shadow-sm ring-black ring-opacity-5">
                        ...
                        <ul role="list" class="flex flex-col w-full h-full">
                                                ...
                                                <li class="px-6 py-4 dark:bg-red-500 hover:bg-opacity-70 dark:hover:bg-opacity-100 grid grid-cols-10 gap-4 items-center">
                                                    ...
                                                    <div class="col-span-2">
                                                        <span class="isolate inline-flex rounded-2xl">
                                                            <button type="button" class="relative inline-flex items-center rounded-l-2xl px-2 py-1.5 text-gray-400 ring-1 ring-inset ring-red-300 hover:bg-gray-50 focus:z-10">
                                                                <span class="sr-only">Previous</span>
                                                                <eye-icon class="w-5 h-5 text-red-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-red-300 hover:bg-gray-50 focus:z-10">
                                                                <check-icon class="w-5 h-5 text-red-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-red-300 hover:bg-gray-50 focus:z-10">
                                                                <arrow-uturn-left-icon class="w-5 h-5 text-red-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center rounded-r-2xl px-2 py-1.5 text-gray-400 ring-1 ring-inset ring-red-300 hover:bg-gray-50 focus:z-10">
                                        ...
                                        <div class="overflow-hidden border-l-4 hover:rounded-l-xl border-blue-500 dark:bg-blue-500">
                                            <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                                                <li class="px-6 py-4 hover:bg-opacity-70 dark:hover:bg-blue-500 dark:hover:bg-opacity-100 grid grid-cols-10 gap-4 items-center" @click="toggleHiddenParagraph(1)">
                                                    ...
                                                    <div class="col-span-2">
                                                        <span class="isolate inline-flex rounded-2xl">
                                                            <button type="button" class="relative inline-flex items-center rounded-l-2xl px-2 py-1.5 text-gray-400 ring-1 ring-inset ring-blue-300 hover:bg-gray-50 focus:z-10">
                                                                <span class="sr-only">Previous</span>
                                                                <eye-icon class="w-5 h-5 text-blue-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-blue-300 hover:bg-gray-50 focus:z-10">
                                                                <check-icon class="w-5 h-5 text-blue-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-blue-300 hover:bg-gray-50 focus:z-10">
                                                                <arrow-uturn-left-icon class="w-5 h-5 text-blue-500" />
                                                            </button>
                                                            <button type="button" class="relative -ml-px inline-flex items-center rounded-r-2xl px-2 py-1.5 text-gray-400 ring-1 ring-inset ring-blue-300 hover:bg-gray-50 focus:z-10">
                                                                <ellipsis-horizontal-icon class="w-5 h-5 text-blue-500" />                                                        
                                                            </button>
                                                        </span> 
                                                    </div>
                                                </li>
                            ...
                            <div class="flex-1 rounded-b-xl bg-gray-100 border-b border-r border-l border-gray-700 border-opacity-20 w-full">
