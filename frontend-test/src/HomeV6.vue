<template>
    ...
    <div class="fixed lg:top-4 lg:left-28 lg:right-4 lg:bottom-4 lg:z-50 rounded shadow ring-1 ring-black ring-opacity-5 bg-white">
    <main class="rounded-t bg-gray-100 shadow"> <!-- OLD : rounded -->
