<template>
    ...
    <main class="rounded-xl bg-gray-100 ring-1 ring-black ring-opacity-5 shadow">
    ...
    <div class="lg:pl-20 rounded-xl lg:mt-4 bg-white ring-1 ring-black ring-opacity-5 ">
                ...
                <ul role="list" class="">
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-red-50 bg-opacity-20 dark:bg-red-500  ring-1 ring-red-700 ring-opacity-20 border-l-4 border-red-500 dark:border-red-300" @click="toggleHiddenParagraph(0)">
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-blue-50 bg-opacity-20 ring-1 ring-blue-700 ring-opacity-20 border-l-4 border-blue-500 dark:bg-blue-500">
                                    <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gray-100 bg-opacity-20 ring-1 ring-gray-700 ring-opacity-20 border-l-4 border-gray-600 dark:bg-gray-500" @click="toggleHiddenParagraph(3)">
