<template>
    ...
    <div class="fixed lg:top-4 lg:left-32 lg:right-4 lg:z-50 rounded-xl">
    ...
    <div class="lg:pl-20 rounded-xl lg:mt-4 bg-white ring-1 shadow-sm ring-black ring-opacity-5">
            <div class="inline-block w-full px-12 py-3">
                <!-- Content goes here -->
                <ul role="list" class="">
                    <li class="py-10">
                        <!-- Your content -->
