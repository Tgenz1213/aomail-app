<template>
    ...
    <div class="fixed lg:top-4 lg:left-28 lg:right-4 lg:z-50 rounded-xl">
    <main class="rounded-xl bg-gray-100 bg-opacity-75 ring-1 ring-black ring-opacity-5 shadow">
                ...
                <div class="col-span-5 h-full flex items-center pb-5">
                    <div class="w-full flex items-center justify-center pt-5">
                        ...
                        <div class="hidden sm:block w-full">
                            ...
                            <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Ecole ESAIP</a>
                            <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Entrepreneuriat</a>
                            <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">Administratifs</a>
                            <a href="#" class=" bg-gray-200 text-gray-800 rounded-md px-16 py-2 text-sm font-medium" aria-current="page">Autres</a>
                            </nav>
                        </div>
                    </div>
                </div>
    ...
    <div class="lg:pl-20 rounded-xl lg:mt-4 bg-white bg-opacity-100 ring-1 ring-black ring-opacity-5 ">
                ...
                <ul role="list" class="">
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            <div class="col-span-1">
                                <div class="flex">
                                    <span class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-red-100 dark:bg-red-200">
                                        <span class="text-lg font-medium leading-none text-red-600 dark:text-red-400">AO</span>
                                    </span>
                                    <!--<ChatBubbleOvalLeftEllipsisIcon class="w-6 h-6 text-red-500" />-->
                                </div>
                            </div>
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gradient-to-r from-red-50 to-red-100 bg-opacity-5 ring-1 ring-red-700 ring-opacity-20 border-l-4 border-red-500 dark:border-red-300" @click="toggleHiddenParagraph(0)">
                                    <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                                        <li class="px-6 py-4 bg-red-50 bg-opacity-50 dark:bg-red-500 hover:bg-opacity-70 dark:hover:bg-opacity-100">
                                            <div class="flex-auto">
                                                <div class="flex items-baseline justify-between gap-x-4">
                                                    <p class="text-sm font-semibold leading-6 text-red-700">Christophe Rouvrais</p>
                                                </div>
                                                <p class="mt-1 text-md text-gray-700 leading-relaxed">Parle de l'aventure entrepreneuriale de Malcom Morel.</p>
                                            </div>
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gradient-to-r from-blue-50 to-blue-100 bg-opacity-5 ring-1 ring-blue-700 ring-opacity-20 border-l-4 border-blue-500 dark:bg-blue-500">
                                    <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                                        <li class="px-6 py-4 bg-blue-50 bg-opacity-50 hover:bg-opacity-70 dark:hover:bg-blue-500 dark:hover:bg-opacity-100" @click="toggleHiddenParagraph(1)">
                                            <div class="flex-auto">
                                                <div class="flex items-baseline justify-between gap-x-4">
                                        ...
                                        <li class="px-6 py-4 bg-blue-50 bg-opacity-50 hover:bg-opacity-70 dark:hover:bg-blue-500 dark:hover:bg-opacity-100" @click="toggleHiddenParagraph(2)">
                                            <div class="flex-auto">
                                                <div class="flex items-baseline justify-between gap-x-4">
                    ...
                    <li class="py-10">
                        ...
                        <div class="grid grid-cols-12 gap-0">
                            ...
                            <div class="col-span-9">
                                <div class="overflow-hidden rounded-md bg-gradient-to-r from-gray-100 to-gray-200 bg-opacity-5  ring-1 ring-gray-700 ring-opacity-20 border-l-4 border-gray-600 dark:bg-gray-500" @click="toggleHiddenParagraph(3)">
                                    <ul role="list" class="divide-y divide-gray-200">
                                        <li class="px-6 py-4 bg-gray-100 bg-opacity-50 hover:bg-opacity-70 dark:hover:bg-gray-500 dark:hover:bg-opacity-100">
                                            <p class="text-gray-600 dark:text-gray-50">
                                                Vous avez reçu <span class="font-semibold text-gray-800 dark:text-white hover:text-gray-700">4</span> mails inutiles
                                            </p>
