<template>
    ...
    <div class="h-screen flex flex-col pr-4 pl-28 pt-4">
    ...
    <div class="lg:pl-20 flex-1 rounded-xl lg:mt-4 bg-white ring-1 shadow-sm ring-black ring-opacity-5 mb-4">
            <div class="inline-block w-full px-12">
                <!-- Content goes here -->
                <ul role="list" class="">
                    <li class="pt-10">
                        <!-- Your content -->
