<template>
    ...
    <div class="h-screen flex space-x-4 pr-4 pl-28 py-4">
    <main class="rounded-xl w-1/5 bg-gray-100 bg-opacity-75 ring-1 shadow-sm ring-black ring-opacity-5">
        <div class="px-4 sm:px-6 lg:px-8">
            <nav class="flex justify-center space-x-4 w-full" aria-label="Tabs">
                <div class="grid grid-rows gap-6 items-center">
                    <!-- Current: "bg-gray-200 text-gray-800", Default: "text-gray-600 hover:text-gray-800" -->
                    <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-16 text-sm font-medium border border-gray-800">Ecole ESAIP</a>
                    <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-16 text-sm font-medium">Entrepreneuriat</a>
                    <a href="#" class=" text-gray-600 hover:bg-gray-200 hover:text-gray-800 rounded-md px-8 py-16 text-sm font-medium">Administratifs</a>
                    <a href="#" class=" bg-gray-200 text-gray-800 text-center rounded-md px-2 py-16 text-sm font-medium" aria-current="page">Autres</a>
                </div>
            </nav>
        </div>
    </main>
    <div class="flex-grow flex justify-center rounded-xl bg-white ring-1 shadow-sm ring-black ring-opacity-5">
                <!-- Content goes here -->
                <ul role="list" class="">
                    <li class="pt-10">
                        <!-- Your content -->
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-11">
                                <div class="overflow-hidden rounded-md bg-red-50 bg-opacity-20 ring-1 ring-red-700 ring-opacity-20 border-l-4 border-red-500 dark:border-red-300" @click="toggleHiddenParagraph(0)">
