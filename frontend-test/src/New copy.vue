<template>
    ...
    <div class="grid grid-cols-2 h-screen lg:pl-20">
        ...
        <div class="bg-white h-full space-y-12 px-6 py-2">
            <form>
                <div class="pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div class="sm:col-span-full text-center">
                      <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Destinaire(s)</label>
                      <div class="mt-2">
                          <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md mx-auto">
                              <input type="text" name="username" id="username" autocomplete="username" class="block flex-1 justify-center items-center border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="janesmith">
                          </div>
                      </div>
                  </div>
                  <div class="sm:col-span-full text-center">
