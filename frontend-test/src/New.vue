<template>
    ...
    <div class="pb-1 lg:pl-20 bg-gray-100">
      ...
      <div class="grid grid-cols-2 h-screen lg:pl-20">
        <div class="bg-gray-100 h-screen">
          <div class="flex flex-col h-full px-10">
              <div class="flex-grow">
                  <div class="flex pt-12 pb-12 justify-center">
                    <div class="mr-4 flex">
                ...
                <div>
                  <div class="mt-2 flex rounded-md shadow-sm">
                    <div class="relative flex flex-grow items-stretch focus-within:z-10">
                      <input type="email" name="email" id="email" class="left-0 pl-3 only:block w-full rounded-none rounded-l-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Instruction">
                    </div>
                    <button type="button" class="relative -ml-px inline-flex items-center gap-x-1.5 rounded-r-md px-3 py-2.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
        ...
        <div class="bg-white h-full space-y-12 px-10 flex items-center justify-center">
            <form>
                <div class="pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full h-full">
                      <button  class="rounded-lg bg-indigo-500 px-8 py-2.5 text-md font-semibold text-white shadow-lg hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Envoyer</button>
                    </div>
                </div>
              </div>
            </form>
