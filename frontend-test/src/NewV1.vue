<template>
    ...
    <div class="fixed top-4 bottom-4 right-4 left-32">
      <div class="grid grid-cols-2">
        <div class="bg-gray-100 bg-opacity-75 rounded-xl lg:ring-1 lg:ring-black lg:ring-opacity-5 shadow hover:shadow-lg mr-2">
          <div class="overflow-y-auto h-[89vh] my-6" style="margin-right: 2px;">
          ...
          <div class="flex-grow">
              ...
              <div class="flex pb-12">
                <div class="mr-4 flex">
                    <span class="inline-flex h-14 w-14 items-center justify-center rounded-full bg-indigo-500">
                        <span class="text-lg font-medium leading-none text-white">AO</span>
                    </span>   
                    <!--<ChatBubbleOvalLeftEllipsisIcon class="w-6 h-6 text-indigo-800" />-->
                </div>
              ...
              <div class="flex pb-12">
                ...
                <div>
                    <p>Bonjour ceci est un test !Bonjour ceci est un test !Bonjour ceci est un test !Bonjour ceci est un test !Bonjour ceci est un test !</p>
                </div>
              </div>
              <div class="flex pb-12">
                <div class="mr-4 flex">
        ...
        <div class="bg-white flex flex-col items-center justify-center px-10 rounded-xl lg:ring-1 lg:ring-black lg:ring-opacity-5 shadow hover:shadow-lg ml-2">
          <div class="mt-4 bg-rounded-lg" style="background-clip: text; color: transparent;">
            <h1 class="px-4 py-2 text-center text-white font-semibold text-lg">SAISI MANUEL</h1>
          </div>
          <div class="space-y-12">
            <form>
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div class="sm:col-span-full">
                      <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Destinaire(s)</label>
                      <div class="mt-2">
                        <div class="flex items-stretch gap-1">
                          <div class="flex-grow">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full max-w-2xl">
                  ...
                  <div class="sm:col-span-full">
                      <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Objet</label>
                      <div class="mt-2">
                        <div class="flex items-stretch gap-1">
                          <div class="flex-grow">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full max-w-2xl">
                  ...
                  <div class="col-span-full h-full">
                    <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Message</label>
                      <div class="mt-2">
                          <div id="editor" class="w-full max-w-2xl mx-auto h-60 max-h-60 overflow-y-auto"></div> 
                      </div>
                  </div>
                  <div class="col-span-full h-full">
