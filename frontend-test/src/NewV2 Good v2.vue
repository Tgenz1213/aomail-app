    ...
    <div class="flex flex-col justify-center items-center h-full">
      <div class="grid grid-cols-11 2xl:grid-cols-7 gap-4 2xl:gap-6">
        ...
        <div class="col-span-5 2xl:col-span-3 bg-gray-100 bg-opacity-75 rounded-xl lg:ring-1 lg:ring-black lg:ring-opacity-5 shadow hover:shadow-lg h-[750px] w-[625px] 2xl:h-[850px] 2xl:w-[700px]">
          <div class="overflow-y-auto h-[625px] 2xl:h-[725px] mt-6" style="margin-right: 2px;">
        ...
        <div class="col-span-5 2xl:col-span-3 bg-white flex flex-col items-center justify-center px-10 rounded-xl lg:ring-1 lg:ring-black lg:ring-opacity-5 shadow hover:shadow-lg h-[750px] w-[625px] 2xl:h-[850px] 2xl:w-[700px]">
