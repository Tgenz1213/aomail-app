<template>
    ...
    <div class="flex flex-col justify-center items-center h-full">
      <div class="grid grid-cols-11 2xl:grid-cols-7 gap-4 2xl:gap-6">
        ...
        <div class="col-span-10 2xl:col-span-6 bg-white rounded-xl lg:ring-1 lg:ring-black lg:ring-opacity-5 shadow hover:shadow-lg h-[750px] w-[1250px] 2xl:h-[850px] 2xl:w-[1400px]">
          <div class="flex flex-col">
            ...
            <div class="overflow-y-auto" style="margin-right: 2px;">
              <div class="flex-grow p-6"> 
                <div class="flex items-center justify-center w-full lg:h-[555px] 2xl:h-[655px] rounded-lg border-2 border-dashed border-gray-300 text-center">
                  <div class="flex-col">
