<template>
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-4 lg:inset-x-4 rounded-xl lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-indigo-800 lg:shadow  lg:ring-1 lg:ring-black lg:ring-opacity-5">
