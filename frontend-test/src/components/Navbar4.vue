<template>
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-4 lg:inset-x-4 rounded-xl lg:z-50 lg:block lg:w-20 lg:overflow-y-auto">
        ...
        <nav class="mt-8">
            <ul role="list" class="flex flex-col items-center space-y-1">
                <li v-for="item in navigation" :key="item.name">
                    <a :href="item.href" :class="[item.current ? 'bg-white text-gray-900 lg:ring-1 lg:ring-black lg:ring-opacity-5' : 'text-gray-900 hover:text-black hover:bg-white', 'group flex gap-x-3 rounded-md p-3 text-sm leading-6 font-semibold']">
                        <component :is="item.icon" class="h-6 w-6 shrink-0" aria-hidden="true" />
