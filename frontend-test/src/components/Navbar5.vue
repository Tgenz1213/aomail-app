<template>
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-8 lg:inset-x-4 rounded-xl lg:z-50 lg:block lg:w-24 lg:overflow-y-auto">
        ...
        <div class="absolute inset-x-0 bottom-6 flex justify-center items-center flex-col">
          ...
          <p class="text-gray-900 font-semibold text-center">v 1.0.0</p>
        </div>
    </div>
