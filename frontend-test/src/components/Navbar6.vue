<template>
  <div>
    ...
    <div class="hidden lg:fixed lg:inset-y-8 lg:inset-x-6 rounded-xl lg:z-50 lg:block lg:w-48 lg:overflow-y-auto">
        <div class="flex h-16 shrink-0 items-center justify-center">
            <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=black" alt="Your Company" />
        </div>
        <nav class="h-5/6 flex items-center">
        ...
        <div class="absolute inset-x-0 bottom-6 flex justify-center items-center flex-col">
          <!--<img class="h-10 w-auto mb-4" src="../assets/icon_gdpr2.png" alt="Icon GDPR" />-->
          <p class="text-gray-900 font-semibold text-center">version 1.0.0</p>
        </div>
    </div>
