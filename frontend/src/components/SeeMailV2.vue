                      ...
                      <div class="flex justify-center">
                        <span class="isolate inline-flex rounded-2xl">
                            <div
                                ...
                                <div class="relative group">
                                    <div
                                        class="absolute hidden group-hover:block px-4 py-2 bg-black text-white text-sm rounded shadow-lg mt-[35px] -ml-2">
                                        {{ $t('SeeMail_vue.read') }} 
                                    </div>
                                    <button
                            ...
                            <div
                                ...
                                <div class="relative group">
                                    <div
                                        class="absolute hidden group-hover:block px-4 py-2 bg-black text-white text-sm rounded shadow-lg mt-[35px] -ml-7">
                            ...
                            <div
                                ...
                                <div class="relative group">
                                    ...
                                    <button @click="openRuleEditor(email)"
                                        type="button"
                                        class="relative -ml-px inline-flex items-center px-1.5 py-1 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-400 hover:bg-gray-400 focus:z-10">
                                        <BeakerIcon
                                            class="w-5 h-5 text-gray-400 group-hover:text-white" />
                            ...
                            <div
                                ...
                                <div class="relative group">
                                    <div
                                        class="absolute hidden group-hover:block px-4 py-2 bg-black text-white text-sm rounded shadow-lg mt-[35px] -ml-[90px] w-[185px]">
                                        {{ $t('SeeMail_vue.more_actions') }} 
                                    </div>
                                    <Menu as="div"
                                        ...
                                        <div>
                                            <MenuButton
                                                @click="toggleTooltip"
                                                class="relative -ml-px inline-flex items-center rounded-r-2xl px-1.5 py-1 text-gray-400 ring-1 ring-inset ring-gray-400 hover:bg-gray-400 focus:z-10">
                                                <ellipsis-horizontal-icon
                                                    class="w-5 h-5 group-hover:text-white text-gray-400 group-active:text-gray-400 group-focus:text-gray focus:text-gray-400" />
                                            </MenuButton>
                                        </div>
                                        <transition
