<template>
  ...
  <div class="flex flex-col h-full">
    ...
    <div class="flex-1 isolate mx-auto mt-6 h-full grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <div v-for="tier in tiers" :key="tier.id"
        ...
        <p class="mt-6 flex items-baseline gap-x-1">
          ...
          <span class="text-sm font-semibold leading-6 text-gray-600">{{ $t(frequency.priceSuffix) }}</span>
        </p>
...
const frequencies = [
  ...
  { value: 'yearly', label: 'settingsPage.subscriptionPage.yearly', priceSuffix: 'settingsPage.subscriptionPage.perYear' },
]

// TODO: implement traductions (ready and cleaned in the JSON file)
const tiers = [
  {
    name: 'Start',
    id: 'tier-freelancer',
