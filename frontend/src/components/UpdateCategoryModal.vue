          ...
          <div class="flex items-center w-full h-16 bg-gray-50 ring-1 ring-black ring-opacity-5 rounded-t-lg">
            <div class="ml-8 flex items-center space-x-1">
              <p class="block leading-6 text-gray-900" style="font-family: 'Poppins', sans-serif; font-weight: 500;">
                {{ $t('UpdateCategoryModal_vue.titre') }}</p>
            </div>
          </div>
          <div class="flex flex-col gap-4 px-8 py-6">
            <p class="text-red-500" v-if="errorMessage">{{ errorMessage }}</p>
            <div>
              <label for="email" class="block text-sm font-medium leading-6 text-gray-900">{{ $t('UpdateCategoryModal_vue.category') }}</label>
              <div class="mt-2">
            ...
            <div>
              <label for="about" class="block text-sm font-medium leading-6 text-gray-900">{{ $t('UpdateCategoryModal_vue.description') }}</label>
              <div class="mt-2">
              ...
              <p class="mt-3 text-sm leading-6 text-gray-600">{{ $t('UpdateCategoryModal_vue.desc2') }}</p>
            </div>
