        ...
        >
            <div class="bg-white rounded-lg relative w-[450px]">
                <div class="absolute right-0 top-0 hidden pr-4 pt-4 sm:block p-8">
                    <button
                        @click="closeWarningCategoryModal"
                        type="button"
                            ...
                            <div class="pt-6">
                                ...
                                >
                                    <div class="px-6 pb-6">
                                        ...
                                        <div
                                            v-for="(emailsByDate, date) in groupedEmailsByCategoryAndDate('Important')"
                                            :key="date"
                                        >
                                            <div class="pt-3 px-4">
                                                <div class="relative">
                                            ...
                                            <div class="flex px-4 pt-4">
                                                <div class="flex">
                                                    ...
                                                    >
                                                        <!--OLD DO NOT DELETE : bg-orange-400-->
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            fill="none"
                                                            viewBox="0 0 24 24"
                                                                ...
                                                                <div class="col-span-8 cursor-pointer">
                                                                        ...
                                                                        <div class="flex-auto group">
                                                                            <div class="flex gap-x-4">
                                                                                <div class="flex items-center">
                                                                                    <p
                                                                                        class="text-sm font-semibold leading-6 text-orange-700 mr-2"
                                                                                    >
                                                                                        {{ item.name }}
                                                                                    </p>
                                                                                    <p
                                                                                        class="text-sm leading-6 text-orange-700"
                                                                                    >
                                                                                        {{ item.time }}
                                                                                    </p>
                                                                                </div>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            />
                                                                            <p
                                                                                class="text-sm text-gray-600 group-hover:text-white"
                                                                            >
                                                                                {{ attachment.attachmentName }}
                                                                            </p>
                                                                        </div>
                                ...
                                <li
                                    v-if="
                                        emails[selectedTopic] &&
                                        emails[selectedTopic]['Information'] &&
                                        countEmailsInCategoryAndPriority(selectedTopic, 'Information') > 0
                                    "
                                    class=""
                                >
                                    <div class="px-6 pb-6">
                                        ...
                                        <div
                                            v-for="(emailsByDate, date) in groupedEmailsByCategoryAndDate(
                                                'Information'
                                            )"
                                            :key="date"
                                        >
                                                    ...
                                                    >
                                                        <ul role="list" class="divide-y divide-gray-200">
                                                            <li
                                                                v-for="item in emailsByDate"
                                                                :key="item.id"
                                                                class="px-6 py-4 2xl:py-5 hover:bg-opacity-70 grid grid-cols-10 gap-4 items-center"
                                                                @mouseover="setHoveredItem(item.id)"
                                                                @mouseleave="clearHoveredItem"
                                                            >
                                                                <div class="col-span-8 cursor-pointer">
                                                                    <div @click="toggleHiddenParagraph(item.id)">
                                                                        <div class="flex-auto group">
                                                                            <div class="flex gap-x-4">
                                                                                <div class="flex items-center">
                                                                                    <p
                                                                                        class="text-sm font-semibold leading-6 text-blue-800 dark:text-white mr-2"
                                                                                    >
                                                                                        {{ item.name }}
                                                                                    </p>
                                                                                    <p
                                                                                        class="text-sm leading-6 text-blue-800 dark:text-white"
                                                                                    >
                                                                                        {{ item.time }}
                                                                                    </p>
                                                                                </div>
                                                                    ...
                                                                    >
                                                                        <div class="col-span-8 flex-auto">
                                                                            ...
                                                                            >
                                                                                <div class="flex items-center">
                                                                                    <p
                                                                                        class="text-sm font-semibold leading-6 text-gray-800 mr-2"
                                                                                    >
                                                                                        {{ item.name }}
                                                                                    </p>
                                                                                    <p
                                                                                        class="text-sm leading-6 text-gray-800 mr-2"
                                                                                    >
                                                                                        {{ item.time }}
                                                                                    </p>
                                                                                    <p
                                                                                        class="text-xs leading-6 text-gray-800 mr-2"
                                                                                    >
                                                                                        {{ item.date }}
                                                                                    </p>
                                                                                </div>
