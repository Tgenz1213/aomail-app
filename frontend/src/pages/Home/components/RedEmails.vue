<template>
    <div v-if="emails.length > 0" class="px-6 pb-6">
      <div class="bg-red-100 bg-opacity-90 rounded-md">
        <div class="flex px-2 py-2">
          <p class="flex-1 text-sm font-semibold leading-6 text-red-600">
            {{ $t('constants.ruleModalConstants.dangerous') }}
          </p>
          <div class="ml-auto">
    ...
    <div v-for="(emailsByDate, date) in groupedEmails" :key="date">
      ...
      <div class="flex px-4 pt-4">
        ...
        <div class="ml-6 flex-grow">
          <div class="overflow-hidden border-l-4 hover:rounded-l-xl border-red-300" style="overflow: visible;">
