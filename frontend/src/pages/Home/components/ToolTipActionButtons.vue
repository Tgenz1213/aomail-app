<template>
    ...
    >
        ...
        >
            <div v-if="showRuleOptions" class="py-1">
                <MenuItem v-slot="{ active }">
                    <a
                        @click.prevent="handleRuleAction"
            ...
            <div class="py-1">
                <MenuItem v-slot="{ active }">
                    <a
                        @click.prevent="handleReplyLater"
                        :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-1 text-sm']"
                    >
                        <span class="flex gap-x-2 items-center">
                            <svg
...
const handleRuleAction = () => {
    emit("handleRuleAction", props.item)
}

const handleReplyLater = () => {
    emit("handleReplyLater", props.item)
}

const handleTransfer = () => {
    emit("handleTransfer", props.item)
}
</script>
