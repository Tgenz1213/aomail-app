    ...
    >
        <div class="flex-auto group">
            <div class="flex gap-x-4">
                <p :class="`text-sm font-semibold leading-6 text-${color}-800 dark:text-white`">
                    {{ email.name }}
                </p>
                <div
            ...
            <p :class="`mt-1 text-md text-gray-700 leading-relaxed dark:text-${color}-50`">
                {{ email.description }}
            </p>
        </div>
        <ul
...
// todo: copy the functions from ReplyLater and setup with TS
// use postData & getData from @global/fetchData for POST and GET request
</script>
