    ...
    >
        <div class="flex-auto group">
            <div class="flex gap-x-4">
                ...
                <div class="hidden group-hover:block px-2 py-0.5 bg-orange-300 text-white text-sm shadow rounded-xl">
                ...
                <div v-show="hoveredItemId === email.id" class="group action-buttons">
                    <div class="relative group">
                        ...
                        <button
                            ...
                            class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-orange-300 hover:bg-orange-300 focus:z-10"
                        >
                            <ChatBubbleOvalLeftEllipsisIcon class="w-5 h-5 text-orange-400 group-hover:text-white" />
                        </button>
                    </div>
                </div>
                <div v-show="hoveredItemId === email.id" class="group action-buttons">
