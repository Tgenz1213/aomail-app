                    ...
                    <div class="flex-1 truncate">
                      ...
                      <div v-if="rule.mail_stop === true" class="flex gap-1 mt-2">
                        <div class="flex space-x-1 items-center">
                          ...
                          <p class="font-semibold text-sm">{{ $t('rulesPage.blockedEmail') }}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div v-if="rules.length == 0" class="flex p-4 w-full h-full">
            <div
              ...
              <div class="flex-col">
                ...
                <span class="mt-2 block text-sm font-semibold text-gray-900">{{ $t('constants.userActions.createARule') }}</span>
              </div>
            </div>
          </div>
