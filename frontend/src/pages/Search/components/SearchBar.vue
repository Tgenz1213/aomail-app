<template>
  <div class="relative ">
      ...
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form class="relative flex flex-1 items-center" action="#" method="GET">
          ...
          <input v-model="searchQuery" id="search-field"
            ...
            :placeholder="$t('rulesPage.search')"  name="search" />
    ...
    <!-- Filter Modal -->
    <div v-if="showFilterPopup" class="absolute left-0 right-0 mt-1 bg-white border border-gray-300 shadow-lg rounded-md z-50" style="width: 90%;">
      <div class="p-4">
