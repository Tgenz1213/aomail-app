                                ...
                                <nav aria-label="Progress">
                                    <ol role="list" class="flex items-center" v-if="step === 0">
                                        <li class="relative pr-6 sm:pr-16">
                                            ...
                                            >
                                                <span
                                                    class="h-2.5 w-2.5 rounded-full bg-gray-700"
                                                    aria-hidden="true"
                                                ></span>
                                    ...
                                    <ol role="list" class="flex items-center" v-if="step === 3">
                                        <li class="relative pr-2 sm:pr-4">
                                            <!-- Completed Step -->
                                            <div class="absolute inset-0 flex items-center" aria-hidden="true">
                                                <div class="h-0.5 w-full bg-gray-500"></div>
                                            </div>
                                ...
                                <form class="space-y-6">
                                    ...
                                    <div v-if="step === 2">
                                            ...
                                            <div class="pt-2">
                                                <div class="relative items-stretch mt-2">
                                                    <div class="flex flex-col gap-y-4">
                                                        ...
                                                        <div v-if="categories.length === 0">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    {{
                                                                        $t(
                                                                            "constants.categoryModalConstants.addCategory"
                                                                        )
                                                                    }}
                                                                </span>
                                                            </button>
                                                        ...
                                                        <div
                                                            v-else
                                                            class="max-h-64 overflow-y-auto flex flex-col gap-y-4"
                                                        >
                                        ...
                                        <div>
                                            <div class="pt-4">
                                                <button
                                                    @click.prevent="submitSignupData"
...
const updateOldCategoryName = ref("");
const updateCategoryDescription = ref("");
...
function deleteCategoryHandler(category: Category) {
...
function updateCategoryHandler() {
    if (!updateCategoryName.value.trim() || !updateCategoryDescription.value.trim()) {
        errorUpdateMessage.value = i18n.global.t("homepage.modals.pleaseFillAllFields");
    } else if (
        categories.value.some((cat) => cat.name === updateCategoryName.value && cat.name != updateOldCategoryName.value)
    ) {
        errorUpdateMessage.value = i18n.global.t("signUpPart1Page.categoryAlreadyExists");
    } else if (updateCategoryDescription.value.length > 300) {
        errorUpdateMessage.value = i18n.global.t("homepage.modals.maxDescriptionCharacters");
    } else if (updateCategoryName.value.length > 50) {
        errorUpdateMessage.value = i18n.global.t("homepage.modals.maxNameCharacters");
...
function addCategory() {
    if (!categoryName.value.trim() || !categoryDescription.value.trim()) {
        ...
        errorMessage.value = i18n.global.t("signUpPart1Page.categoryAlreadyExists");
...
<!-- TODO:
- separate the modal components into other files ( Update Category modal , Create Category modal)
...
- remove all the garbage comments -->
