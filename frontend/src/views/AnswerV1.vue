          ...
          <div id="firstMainColumn"
            ...
            <div
              ...
              <div class="flex gap-x-2 items-center">
                ...
                <h1 style="font-family: 'Poppins', sans-serif; font-weight: 500;">{{ $t('"Answer_vue.titre') }}</h1>
              </div>
            </div>
            ...
            <div class="flex flex-col divide-y divide-gray-200 h-full w-full">
              <div
                ...
                <div class="flex gap-x-2 items-center">
                  ...
                  <h1 style="font-family: 'Poppins', sans-serif; font-weight: 500;">{{ $t('"Answer_vue.Saisie') }}</h1>
                </div>
              </div>
                        ...
                        <div class="relative items-stretch">
                          <div class="relative w-full">
                            <div v-if="!isFocused2"
                              ...
                              <label for="email"
                                class="block text-sm font-medium leading-6 text-gray-900 pointer-events-none">{{ $t('"Answer_vue.Destinataire') }}</label>
                            </div>
                    ...
                    <div class="flex mb-4">
                      <div class="inline-flex rounded-lg shadow-lg">
                        <button @click.prevent="sendEmail" :disabled="emailAnswered"
                          class="bg-gray-600 rounded-l-lg px-6 py-1 text-md font-semibold text-white hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">{{ $t('"Answer_vue.Actions_envoyer') }}</button>
