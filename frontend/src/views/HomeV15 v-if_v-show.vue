                                    ...
                                    <div class="w-full flex items-center justify-center pt-5">
                                        ...
                                        <div class="hidden sm:block w-full">
                                            <nav class="flex justify-center space-x-4 w-full" aria-label="Tabs">
                                                <a v-for="category in categories" :key="category" href="#" class=" text-gray-600 hover:bg-gray-500 hover:bg-opacity-10 hover:text-gray-800 rounded-md px-8 py-2 text-sm font-medium">{{ category }}</a>
                                            </nav>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="ml-6 flex-grow">
                                        <div class="overflow-hidden border-l-4 border-red-500  hover:rounded-l-xl dark:border-red-300">
                                            <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                                                <li v-for="item in items" :key="item.id" v-if="item.topic === selectedTopic && item.importance === 'Important'" class="px-6 py-4 hover:bg-opacity-70 dark:hover:bg-red-500 dark:hover:bg-opacity-100 grid grid-cols-10 gap-4 items-center" @click="toggleHiddenParagraph(item.id)">
                                                    <div >
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-6 flex-grow">
                                        <div class="overflow-hidden border-l-4 hover:rounded-l-xl border-blue-300 dark:bg-blue-500">
                                            <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                                                <li v-for="item in items" :key="item.id" v-if="item.topic === selectedTopic && item.importance === 'Information'" class="px-6 py-4 hover:bg-opacity-70 dark:hover:bg-blue-500 dark:hover:bg-opacity-100 grid grid-cols-10 gap-4 items-center" @click="toggleHiddenParagraph(item.id)">
                                                    <div >
                                                        <div class="col-span-8">
                                                            <div class="flex-auto">
                                                                <div class="flex items-baseline justify-between gap-x-4">
...
export default {
        ...
        toggleHiddenParagraph(index) {
            ...
            this.$nextTick(() => {
                if (this.showHiddenParagraphs[index] && !this.animationTriggered[index]) {
                    const parentElement = this.$refs['parentElement' + index][1];
    ...
    data() {
        return {
            ...
            // ],
            items: [{"ESAIP": {"Important": {id: 1, name: 'Jean', description: 'test', details: [{id: 1, text: 'text'},{id: 3, text: 'bullet'},{id: 2, text: 'blabla'}]}}}, 
            {"ESAIP":{"Important": {id: 1, name: 'Marc', description: 'Premier test', details: [{id: 4, text: 'bonjour'},{id: 6, text: 'ok'},{id: 5, text: 'enfin'}]}}}]
        }
    }
}
</script>
