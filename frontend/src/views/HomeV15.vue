            ...
            <div class="flex h-full w-full">
                ...
                <div class="w-[325px] 2xl:w-[450px] bg-gray-50 ring-1 shadow-sm ring-black ring-opacity-5">
                    <div class="flex flex-col h-full w-full">
                        ...
                        <div class="flex flex-col h-[170px] lg:border-t lg:border-black lg:border-opacity-10">
                            <textarea id="dynamicTextarea" @keydown.enter="handleEnterKey"
                                @input="adjustHeight" v-model="textareaValue"
                                class="overflow-y-hidden pt-2 pl-4 flex-1 w-full border-transparent bg-transparent text-gray-900 placeholder:text-gray-400 sm:text-sm sm:leading-6 focus:border-transparent focus:bg-transparent focus:ring-0"
                                placeholder="Instruction">
                            </textarea>
                            <div class="flex justify-end m-2">
                                <button type="button" class="w-[80px] rounded-md bg-gray-900 px-2.5 py-1.5 text-sm text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Envoyer</button> 
                            </div>
                        </div>
                    </div>
                </div>
