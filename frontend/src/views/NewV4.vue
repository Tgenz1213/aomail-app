                ...
                <div id="firstMainColumn"
                    ...
                    <div class="flex items-center justify-center h-[65px] 2xl:h-[80px]">
                        <div class="flex gap-x-3 items-center">
                            ...
                            <h1 class="font-poppins font-medium text-base 2xl:text-lg">{{ $t('New_vue.titre') }}</h1>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col h-full w-full">
                        <div class="flex items-center justify-center h-[65px] 2xl:h-[80px]">
                            <div class="flex gap-x-3 items-center">
                                ...
                                <h1 class="font-poppins font-medium text-base 2xl:text-lg">{{ $t('New_vue.Saisie') }}</h1>
                            </div>
                        </div>
                                            ...
                                            <div class="relative items-stretch">
                                                <div class="relative w-full">
                                                    <div v-if="!isFocused2"
                                                        ...
                                                        <label for="email"
                                                            class="block text-sm font-medium leading-6 text-gray-900 pointer-events-none 2xl:text-base">{{ $t('New_vue.Destinataire') }}</label>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="relative w-full">
                                                    <div v-if="!isFocused && !inputValue"
                                                        ...
                                                        <label for="username"
                                                            class="block text-sm font-medium leading-6 text-gray-900 pointer-events-none 2xl:text-base">{{ $t('New_vue.Objet') }}</label>
                                                    </div>
                                ...
                                <div class="flex gap-x-2 mb-5 2xl:gap-3 2xl:mb-6">
                                    ...
                                    <div class="inline-flex rounded-lg shadow-lg">
                                        <button @click="sendEmail"
                                            class="bg-gray-700 rounded-l-lg px-6 py-1 text-md font-semibold text-white hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600 flex gap-x-2 items-center 2xl:px-7 2xl:py-2 2xl:text-lg">{{ $t('New_vue.Action_envoyer') }} 
