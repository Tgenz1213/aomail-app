                    ...
                    <div class="flex flex-1 flex-col divide-y">
                        ...
                        <div class="flex flex-col h-[22vh] 2xl:h-[23vh]">
                            ...
                            <div class="flex justify-end m-3 2xl:m-5">
                                <button @click="handleAIClick" type="button" class="2xl:w-[100px] w-[80px] rounded-md bg-gray-700 px-5.5 py-2.5 2xl:px-6.5 2xl:py-3 2xl:text-base text-sm text-white shadow-sm hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Envoyer</button> 
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col h-full w-full">
                        <div class="flex items-center justify-center h-[65px] 2xl:h-[80px]">
                            <div class="flex gap-x-3 items-center">
                                ...
                                <h1 class="font-poppins font-medium text-base 2xl:text-lg">{{ $t('New_vue.enter_manually') }}</h1>
                            </div>
                        </div>
                                            ...
                                            <div class="relative items-stretch">
                                                <div class="relative w-full">
                                                    <div v-if="!isFocused2"
                                                        ...
                                                        <label for="email"
                                                            class="block text-sm font-medium leading-6 text-gray-900 pointer-events-none 2xl:text-base">{{ $t('New_vue.recipient') }}</label>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="relative w-full">
                                                    <div v-if="!isFocused && !inputValue"
                                                        ...
                                                        <label for="username"
                                                            class="block text-sm font-medium leading-6 text-gray-900 pointer-events-none 2xl:text-base">{{ $t('New_vue.subject') }}</label>
                                                    </div>
                                ...
                                <div class="flex gap-x-2 mb-5 2xl:gap-3 2xl:mb-6">
                                    ...
                                    <div class="inline-flex rounded-lg shadow-lg">
                                        <button @click="sendEmail"
                                            class="bg-gray-700 rounded-l-lg px-6 py-1 text-md font-semibold text-white hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600 flex gap-x-2 items-center 2xl:px-7 2xl:py-2 2xl:text-lg">{{ $t('New_vue.send') }} 
