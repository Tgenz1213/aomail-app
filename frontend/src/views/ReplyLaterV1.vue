            ...
            <div class="px-4 py-2 h-full">
              ...
              <div v-if="nbr_reply_answer > 0">
                <ul role="list" class="flex flex-col w-full h-full rounded-xl">
                    <li v-if="emails['Important'] && emails['Important'].length > 0" class="py-10 px-8 mt-2 rounded-xl bg-red-100 bg-opacity-50 hover:ring-1 ring-offset-0 ring-red-700 ring-opacity-20">
                      ...
                      <div class="flex">
                        ...
                        <div class="ml-6 flex-grow">
                          <div class="overflow-hidden border-l-4 border-red-500  hover:rounded-l-xl" style="overflow: visible;">
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                              <li v-for="item in emails['Important']" :key="item.id" class="px-6 md:py-2 2xl:py-4 hover:bg-opacity-70 grid grid-cols-10 gap-4 items-center" @mouseover="setHoveredItem(item.id)" @mouseleave="clearHoveredItem">
                                ...
                                <div class="col-span-2">
                                  <div class="flex justify-center">
                                      <span class="isolate inline-flex rounded-2xl">
                                          ...
                                          <div v-show="hoveredItemId === item.id" class="group action-buttons">
                                              <div class="relative group">
                                                  <div class="absolute hidden group-hover:block px-4 py-2 bg-black text-white text-sm rounded shadow-lg mt-[-45px] -ml-8">
                                                      Supprimer
                                                  </div>
                                                  <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-red-300 hover:bg-red-300 focus:z-10">
                                                      <TrashIcon @click.stop="deleteEmail(item.id)" class="w-5 h-5 text-red-400 group-hover:text-white" />
                                                  </button>
                                              </div>
                                          </div>
                                          <div v-show="hoveredItemId === item.id" class="group action-buttons">
                                            <div class="relative group">
                                                <div v-if="showTooltip" class="absolute hidden group-hover:block px-4 py-2 bg-black text-white text-sm rounded shadow-lg mt-[-45px] -ml-20 w-[180px]">
                    ...
                    <li v-if="emails['Information'] && emails['Information'].length > 0" class="py-10 px-8 mt-2 rounded-xl bg-blue-100 bg-opacity-50 hover:ring-1 ring-offset-0 ring-blue-700 ring-opacity-20"> <!-- ring-1 ring-blue-700 ring-opacity-20 -->
                      <div class="float-right mt-[-25px] mr-[-10px]">
                    ...
                    <div v-if="emails['Useless'] && emails['Useless'].length > 0" class="py-10 px-8 mt-2 rounded-xl bg-gray-100 hover:border border-gray-700 border-opacity-20 w-full">
                      <div class="float-right mt-[-25px] mr-[-10px]">
                      ...
                      <div class="flex">
                        ...
                        <div class="ml-6 flex-grow">
                          <div class="overflow-hidden border-l-4 hover:rounded-l-xl border-gray-500" style="overflow: visible;">
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-white">
                              <li v-for="item in emails['Useless']" :key="item.id" class="px-6 md:py-2 2xl:py-4 hover:bg-opacity-70 grid grid-cols-10 gap-4 items-center" @mouseover="setHoveredItem(item.id)" @mouseleave="clearHoveredItem">
                                <div class="col-span-8" @click="toggleHiddenParagraph(item.id)">
                                  <div class="flex-auto group">
                                    <div class="flex gap-x-4">
                                      <p class="text-sm font-semibold leading-6 text-gray-800">{{ item.name }}</p>
                                      <div class="hidden group-hover:block px-2 py-0.5 bg-gray-500 text-white text-sm shadow rounded-xl">
                                        <div class="flex gap-x-1 items-center">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672Zm-7.518-.267A8.25 8.25 0 1 1 20.25 10.5M8.288 14.212A5.25 5.25 0 1 1 17.25 10.5" />
                                          </svg>
                                      ...
                                      <span class="isolate inline-flex rounded-2xl">
                                          <div v-show="hoveredItemId === item.id" class="group action-buttons">
                                              <div class="relative group">
                                                  ...
                                                  <button @click="openInNewWindow(item.id_provider)" type="button" class="relative inline-flex items-center rounded-l-2xl px-2 py-1.5 text-gray-400 ring-1 ring-inset ring-gray-400 hover:bg-gray-400 focus:z-10">
                                          ...
                                          <div v-show="hoveredItemId === item.id" class="group action-buttons">
                                              <div class="relative group">
                                                  ...
                                                  <button type="button" class="relative -ml-px inline-flex items-center px-2 py-1.5 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-400 hover:bg-gray-400 focus:z-10">
                                                      <TrashIcon @click.stop="deleteEmail(item.id)" class="w-5 h-5 text-gray-500 group-hover:text-white" />
                                                  </button>
                                              </div>
                                          </div>
                                          <div v-show="hoveredItemId === item.id" class="group action-buttons">
