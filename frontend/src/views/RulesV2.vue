<template>
          ...
          <div class="flex flex-col h-full relative"> <!-- ADDED relative -->
            ...
            <div class="flex-grow overflow-y-auto" style="margin-right: 2px;">
              <div class="p-6 h-full">
                ...
                <div v-if="rules.length == 0" class="flex items-center justify-center w-full h-full rounded-lg border-2 border-dashed border-gray-300 hover:border-gray-800 text-center" @click="showModal = true">
                  <div class="flex-col">
            ...
            <div v-if="rules.length > 0" class="flex items-center justify-center w-auto right-6 left-6 absolute bottom-6 h-[85px] rounded-lg border-2 border-dashed border-gray-300 hover:border-gray-800 text-center" @click="showModal = true">
              <div class="flex-col">
    ...
    <ModalSeeRule :isOpen="showModal" @update:isOpen="updateModalStatus" :emailSenders="emailSenders" :categories="categories" :sender="senderSelected" />
    <UpdateRule :isOpen="showUpdateModal" :rule="ruleSelected" :categories="categories" :emailSenders="emailSenders" @update:isOpen="updateModalUpdateStatus" />
</template>
