        ...
        <div class="flex flex-col h-full relative"> <!-- ADDED relative -->
          <div class="divide-y divide-gray-200">
            <div
              ...
              <h1 style="font-family: 'Poppins', sans-serif; font-weight: 500;">{{ $t('Rules_vue.titre') }}</h1>
            </div>
                    ...
                    <div class="flex-1 truncate">
                      ...
                      <div v-if="rule.priority !== ''" class="flex gap-1 mt-2">
                        <div class="flex space-x-1 items-center">
                          ...
                          <p class="font-semibold text-sm">{{ $t('Rules_vue.prio') }}</p>
                        </div>
                      ...
                      <div v-if="rule.mail_stop === true" class="flex gap-1 mt-2">
                        <div class="flex space-x-1 items-center">
                          ...
                          <p class="font-semibold text-sm">{{ $t('Rules_vue.mail') }}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div v-if="rules.length == 0" class="flex p-4 w-full h-full">
            <div
              ...
              <div class="flex-col">
                ...
                <span class="mt-2 block text-sm font-semibold text-gray-900">{{ $t('Rules_vue.règles') }}</span>
              </div>
            </div>
          </div>
          <div v-if="rules.length > 0"
            ...
            <div class="flex-col">
              ...
              <span class="mt-2 block text-sm font-semibold text-gray-900">{{ $t('Rules_vue.titre') }}</span>
            </div>
          </div>
        </div>
      </div>
