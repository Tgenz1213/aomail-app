                ...
                <div class="flex flex-col">
                  <div class="relative">
                    ...
                    <div class="relative flex justify-center">
                      <span class="bg-white px-2 text-sm text-gray-500">Changement d'Email ou Mot de Passe</span>
                    </div>
                  </div>
                  <div class="pt-6 pb-10">
                    ...
                    <div class="relative items-stretch mt-2">
                      <input v-model="userData.username" type="text" name="username" id="username" autocomplete="username"
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        <div>
                          <div class="flex space-x-1 items-center">
                            ...
                            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Nouveau mot de
                              passe</label>
                          </div>
                          <div class="relative items-stretch mt-2">
                            <input v-model="newPassword" type="text" name="first-name" id="first-name"
                        ...
                        <div>
                          <div class="flex space-x-1 items-center">
                            <key-icon class="w-4 h-4" />
                            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Confirmer le mot
                              de passe</label>
                          </div>
                          <div class="relative items-stretch mt-2">
                            <input v-model="confirmPassword" type="text" name="first-name" id="first-name"
                              autocomplete="given-name"
                              class="block w-full rounded-md border-0 pl-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-800 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                  ...
                  <div class="pt-6">
                    <div class="flex space-x-1 items-center">
                      <input type="radio"
                        ...
                        name="choice">
                      <label for="push-everything" class="block text-sm font-medium leading-6">Je confirme la supression
