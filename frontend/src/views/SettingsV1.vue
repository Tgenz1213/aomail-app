                            ...
                            <div class="flex gap-x-10 h-full w-full py-10 px-8 2xl:py-14 2xl:px-12">
                                ...
                                <div class="flex-1 flex-col h-full flex-grow px-4 py-6">
                                    ...
                                    <div class="relative py-4">
                                        ...
                                        <div class="relative flex justify-center">
                                            <span class="bg-white px-2 text-sm text-gray-500">
                                                Choose the email service provider
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pt-4">
                                            <div class="relative items-stretch mt-2 flex justify-center items-center">
                                                <button type="button"
                                                    ...
                                                    <span
                                                        class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden w-max px-2 py-1 text-xs text-white bg-black rounded-md group-hover:block">Securely
