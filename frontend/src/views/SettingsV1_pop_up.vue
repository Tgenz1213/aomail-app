...
async function handleColorChange(newColor) {
    ...
    try {
        ...
        if (response.bg_color) {
            ...
            //showSuccessNotification('Background updated', 'Votre Background a ete mis a jour');
...
//             'Content-Type': 'application/json'
//         },
//         body: JSON.stringify({ username: userData.value.username })
//     };
